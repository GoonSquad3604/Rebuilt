...
public class PrimaryLauncherIOPhoenix implements PrimaryLauncherIO {
  ...
  public PrimaryLauncherIOPhoenix() {

    launcherMotor =
        new TalonFX(ShooterConstants.PrimaryLauncherConstants.launcherID, Constants.CANBusName);
    ...
    launcherMotorConfig.Slot0 =
        new Slot0Configs()
            .withKP(ShooterConstants.PrimaryLauncherConstants.launcherP)
            .withKI(ShooterConstants.PrimaryLauncherConstants.launcherI)
            .withKD(ShooterConstants.PrimaryLauncherConstants.launcherD)
            .withKS(ShooterConstants.PrimaryLauncherConstants.launcherS)
            .withKV(ShooterConstants.PrimaryLauncherConstants.launcherV);
  ...
  @Override
  public void updateInputs(PrimaryLauncherIOInputs inputs) {
