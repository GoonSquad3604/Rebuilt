...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    // cllimber testing
    driverController.povUp().onTrue(Commands.runOnce(() -> climber.setPowerInnerRungs(-0.8)));
    driverController.povUp().onFalse(Commands.runOnce(() -> climber.setPowerInnerRungs(0.0)));

    driverController.povDown().onTrue(Commands.runOnce(() -> climber.setPowerInnerRungs(0.8)));
