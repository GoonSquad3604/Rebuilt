...
//             turretAngle.minus(lastTurretAngle).getRadians() / ShooterConstants.loopPeriodSecs);
//     hoodVelocity =
//         hoodAngleFilter.calculate((hoodAngle - lastHoodAngle) / ShooterConstants.loopPeriodSecs);
